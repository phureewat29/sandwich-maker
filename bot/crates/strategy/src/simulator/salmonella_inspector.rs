...
impl SalmonellaInspectoooor {
    ...
    //
    // Returns:
    // IsSandwichSafu: enum that is either Safu or NotSafu
    pub fn is_sandwich_safu(self) -> IsSandwichSafu {
        ...
        match self.suspicious_opcodes.len() == 0 {
            true => IsSandwichSafu::Safu,
            false => IsSandwichSafu::NotSafu(suspicious_opcodes),
        }
    }
}
